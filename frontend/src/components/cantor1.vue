<template>
    <el-container class="page-cantor" v-loading="loading" :style="areaStyle">
        ...
        <el-main class="main-area" data-wails-no-drag>
            <el-template>
                <div class="main-drag-area" data-wails-drag></div>
            </el-template>
            <el-table
                :key="tableKey"
